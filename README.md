...
- FArchive 클래스를 활용한 메모리 아카이브와 파일 아카이브 활용
...
- 패키지의 중의적 개념
  ...
  - 또한 개발된 최종 콘텐츠를 정리해 프로그램으로 만드는 작업을 의미함.
...
- 언리얼 오브젝트 패키지의 서보 오브젝트를 애셋이라고 하며 에디터에는 이들이 노춤됨.
